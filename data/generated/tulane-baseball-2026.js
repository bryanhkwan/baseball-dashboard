...
window.__BASEBALL_DATASETS__.tulane2026 = {
  "generatedAt": "2026-04-17T11:14:05.615Z",
  "season": 2026,
  "school": {
    "slug": "tulane",
    "name": "Tulane",
    ...
    "ncaaRecord": {
      "slug": "tulane",
      "name": "Tulane",
      "long": "Tulane University"
    },
    "espnDisplayName": "",
    "espnSlug": "",
    "rosterUrl": "https://tulanegreenwave.com/sports/baseball/roster",
    "statsUrl": "https://tulanegreenwave.com/sports/baseball/stats/2026",
    "pdfUrl": "https://s3.us-east-2.amazonaws.com/sidearm.nextgen.sites/tulanegreenwave.com/stats/baseball/2026/pdf/cume.pdf"
  },
  "sources": {
    "roster": "Tulane Athletics roster",
    "stats": "Tulane Athletics cumulative stats",
    "espn": "ESPN team identity verified, but Tulane's public roster feed did not match the current 2026 school-site roster",
  ...
  "players": [
    ...
    },
    {
      ...
      "evaluation": {
        ...
        "summary": "Max Mazinter looks like a RHP option who throws enough strikes.",
        "summaryMetrics": [
          "ERA --",
          "WHIP --",
          "K/9 0.0"
    ...
    },
    {
      ...
      "evaluation": {
        ...
        "components": {
          "Run prevention": 0,
          "Traffic control": 0,
          "Miss bats": 81.58205430932703,
          "Command": 41.666666666666664,
          "Damage suppression": 0
        },
        "summary": "Sam Larson looks like a RHP option who limits runs and misses bats and keeps traffic under control.",
        "summaryMetrics": [
          "ERA 3.16",
          "WHIP 1.09",
          "K/9 13.0"
    ...
    },
    {
      ...
      "evaluation": {
        ...
        "summary": "Julius Ejike-Charles looks like a OF/LHP option who limits runs.",
        "summaryMetrics": [
          "ERA 3.18",
          "WHIP 1.41",
          "K/9 7.9"
    ...
    },
    {
      ...
      "evaluation": {
        ...
        "summary": "Jason Wachs profiles as a OF piece who gets on base at a high clip and controls at-bats.",
        "summaryMetrics": [
          "AVG .341",
          "OBP .480",
          "SLG .538"
    ...
    },
    {
      ...
      "evaluation": {
        ...
        "components": {
          "Run prevention": 0,
          "Traffic control": 0,
          "Miss bats": 53.081664098613246,
          "Command": 17.391304347826082,
          "Damage suppression": 0
        },
        "summary": "J.D. Rodriguez looks like a RHP option who limits runs and misses bats.",
        "summaryMetrics": [
          "ERA 3.66",
          "WHIP 1.45",
          "K/9 9.8"
    ...
    },
    {
      ...
      "evaluation": {
        ...
        "summary": "Jack Brafa looks like a RHP option who limits runs and misses bats and keeps traffic under control.",
        "summaryMetrics": [
          "ERA 2.84",
          "WHIP 1.18",
          "K/9 9.9"
    ...
    },
    {
      ...
      "evaluation": {
        ...
        "summary": "Jake Toporek looks like a LHP option who limits runs and misses bats and throws enough strikes and keeps traffic under control.",
        "summaryMetrics": [
          "ERA 2.90",
          "WHIP 1.19",
          "K/9 10.2"
    ...
    },
    {
      ...
      "evaluation": {
        ...
        "summary": "Tom Vincent looks like a LHP option who keeps traffic under control.",
        "summaryMetrics": [
          "ERA 5.82",
          "WHIP 1.24",
          "K/9 7.4"
    ...
    },
    {
      ...
      "evaluation": {
        ...
        "summary": "Aidan Rath looks like a RHP option who limits runs and misses bats.",
        "summaryMetrics": [
          "ERA 0.00",
          "WHIP 2.00",
          "K/9 9.0"
